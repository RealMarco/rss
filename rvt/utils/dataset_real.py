...
from peract_colab.rlbench.real_utils import get_stored_demo
...
from rvt.utils.real_world_const import LOW_DIM_SIZE, IMAGE_SIZE, CAMERAS
...
def fill_replay(
    ...
    if disk_exist:
        ...
        for d_idx in range(start_idx, start_idx + num_demos):
            ...
            episode_keypoints = list(range(len(demo)))
