...
from rvt.utils.dataset_modi import create_replay, fill_replay
...
def get_dataset(
    ...
    for task in tasks:  # for each task
        ...
        # if refresh_replay, then remove the existing replay data folder,default is false
        if refresh_replay:
